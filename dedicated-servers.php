		...
		<div class="container">
			...
			<div class="row text-center">
				<table class="plan-table">
					...
					{{/features}}
						<td>
							<a href="http://my.galacticservers.com/cart.php?a=confproduct&i=0" class="btn btn-primary btn-block btn-lg">Order Now for {{price}}</a>
						</td>
					</tr>
					{{/dedicated}}
				</table>
			...
			<div class="row bannerbtn">
				<div class="col-md-6">Need something <i>more flexible?</i></div>
				<a href="//galacticservers.com/vps" class="col-md-6">Check out our VPS's</a>
			</div>
		</div>
	</div>
