			...
			<div class="container">
				...
				<?php
					$plans = array(
						...
						array("name" => 'Mars',      'size' => '1.0GB', 'price' => '7.99',  'url' => 'https://my.galacticservers.com/cart.php?a=add&pid=2'),
					...
					for ($row = 0; $row < 14; $row++) {
						...
						echo "	<a class='plan' href='" . $plans[$row]["url"] . "'>";
						echo "		<div class='thumb' style='background-image:url(&quot;img&#47;plan&#47;" . $plans[$row]["name"] . ".jpg&quot;)'>";
						echo "			" . $plans[$row]["name"] . "";
						echo "		</div>";
						echo "		<span>" . $plans[$row]["size"] . "</span>";
						echo "		<b>" . $plans[$row]["price"] . "</b>";
						echo "	</a>";
						echo "</div>";
					}
					?>
						...
						<table class="btntable">
							<tr>
								<td style="border-top-left-radius: 10px;">
									Want to get your server for free or start making money with us? Join our affiliate team today and begin something awesome!
							...
							<tr>
								<td style="border-bottom-left-radius: 10px;">
									Get a your own website coded to look professional for up to 30% off if you purchase any server from 4GB of RAM and upwards.
